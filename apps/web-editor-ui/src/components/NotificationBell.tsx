...
const NotificationItem: React.FC<NotificationItemProps> = ({
  ...
  const alreadyJoined = n.type === 'collaborator_joined';
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        {/* Icon */}
        <div
          className={`flex-shrink-0 w-8 h-8 rounded-full border flex items-center justify-center mt-0.5 ${
            alreadyJoined
        ...
        >
          <Users
            className={`w-3.5 h-3.5 ${
              alreadyJoined ? 'text-emerald-600' : 'text-amber-600'
            }`}
          />
        </div>
        ...
        <div className="flex-1 min-w-0">
          <p className="text-[12.5px] text-slate-800 leading-relaxed">
            ...
            {alreadyJoined ? ' a rejoint ' : ' demande à rejoindre '}
